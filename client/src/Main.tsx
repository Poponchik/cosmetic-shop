      ...
      <body>
        <div className={styles.inner_container}>
          <div className={styles.main_screen}>
            <div className={styles.left_div}>
              ...
              <Link to="/catalog" className={styles.link}>
                <button
                  className={classNames(styles.main_button, styles.button)}
                >
                  Catalog
                </button>
              </Link>
          ...
          <div className={styles.opportunities}>
            ...
            <div className={styles.opportunity}>
              <FaPaw size={16} className={styles.opportunity_icon} />
              <div className={styles.opportunity_block}>
                <p className={styles.title_opportunity}>No cruelty</p>
                <p className={styles.description_opportunity}>
                  Our products are not tested on animals. Kittens are only for
                  big love.
                </p>
              </div>
            </div>
            ...
            <div className={styles.opportunity}>
              <AiFillCheckCircle
                size={16}
                className={styles.opportunity_icon}
              />
              <div className={styles.opportunity_block}>
        ...
        <div className={styles.discount_block}>
          <div className={styles.title_discount}>
            <h2 className={styles.title}>
              Do you want a discount? - Subscribe!
            </h2>
          ...
          <div className={styles.reviews_block_arrows}>
            ...
            <div className={styles.reviews}>
              ...
              <div className={styles.review}>
                ...
                <p className={styles.review_text}>
                  I love Benton! I've been with them for 3 years now. These are
                  my favorite skin care products. The quality is consistently
                  high. The service is excellent and very warm - you can feel
                  that customers are loved and appreciated here.
                </p>
              </div>
            </div>
            <IoIosArrowForward className={styles.arrow_right} size={24} />
